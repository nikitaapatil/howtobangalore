...
const BlogPost = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {showShareSuccess && (
        <div className="fixed top-4 right-4 bg-green-500 text-white px-4 py-2 rounded-lg shadow-lg z-50 transition-all duration-300 ease-in-out transform translate-x-0">
